...
(function(document) {
    ...
    <body class="skin-black" bgcolor="white">
...
<header class="header">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
				...
				<h3>Vulnerabilities Archived</h3>  <h2>1187</h2>
					</div> -->
					<center>
				...
				<h4><font color="#CCC">Search the Database for Vulnerabilities, Affected Products, Risk, Threats & Exploits
                 ...
                 <!--  <div class="col-lg-12" style="width: 800px"> -->
                      <!-- <section class="panel"> -->
                         ...
                         <form id="searchbox" action="advanvcesearchfilter1.jsp" method="post" autocomplete="off">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="search" type="text" placeholder="CVE ID (eg: 2015-1423)" style="width: 250px" name="productname">
