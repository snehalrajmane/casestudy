...
(function(document) {
    ...
    <body class="skin-black">
       ...
       <%String uname=(String)session.getAttribute("name"); %>
          ...
          <%String cveid=request.getParameter("productname");
...
<%-- Value=<%=cveid%> --%>
<%int cveidflag=0,finalcount=0,RecordFoundFlag=0;%>

<% if(cveid.equalsIgnoreCase("")||cveid.equalsIgnoreCase(null))
	cveidflag=1;
%>
 <% if(cveidflag==0){%>
 <% DatabaseManager db;
	db = DatabaseManager.getInstance();
		ResultSet rs=db.showCVEIDSearch(cveid);
                           ...
                           <tbody>
                             ...
                             <tr>
                               ...
                               <th><i class="icon_calendar"></i>Product Name</th>
                                 ...
                                 <th><i class="icon_pin_alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vulnerability&nbsp;&nbsp; Name </th>
                                 <th><i class="icon_mail_alt"></i>CVE-ID</th>
...
int count=0;%>
	...
	db = DatabaseManager.getInstance();
		...
		{%>
          				...
          				<%-- <td><%=SEVERITY2%></td> --%>
                         	<%if(SEVERITY2.equalsIgnoreCase("low")) {%>
								<td style="color:GREEN;" ><%=SEVERITY2%></td>
							<% }%>
							<%if(SEVERITY2.equalsIgnoreCase("medium")) {%>
								<td style="color:ORANGE;"><%=SEVERITY2%></td>
							<% }%>
							<%if(SEVERITY2.equalsIgnoreCase("HIGH")) {%>
								<td style="color:RED;"><%=SEVERITY2%></td>
							<% }%>
							<%if(SEVERITY2.equalsIgnoreCase("CRITICAL")) {%>
								<td style="color:PURPLE;"><%=SEVERITY2%></td>
								<% }%>
								<%if(SEVERITY2.equalsIgnoreCase("Not Vulnerable")) {%>
								<td style="color:LIGHTGREEN;"><%=SEVERITY2%></td>
								<% }%>
								<td><%=COMMENTS%></td>
                                 <%-- <td><textarea cols="50" name="comments" id="demo" readonly><%=COMMENTS%></textarea></td> --%>
		...
		<%-- only product count=<%=count %> --%>
                    ...
                    <% }else{%>
                    <%
                    	out.println("No Vulnerabilities Found!!!!");
